    ...
    <form wire:submit.prevent="saveVoting">
        ...
        <div class="mb-6">
            ...
            @foreach($options as $index => $option)
                <div class="flex flex-col mb-3 gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <!-- Tombol untuk menghapus opsi -->
                        <button
                            type="button"
                            wire:click="removeOption({{ $index }})"
                            class="ml-2 text-white bg-red-500 rounded-xl px-2 py-1 flex gap-1 items-center">
                    ...
                    <!-- Input untuk gambar -->
                    @if ($images[$index])
                        <div class="mt-2 relative p-1 shadow-lg w-20">
                            <!-- Preview Image -->
                            <img src="{{ $images[$index]->temporaryUrl() }}" alt="Preview Foto" class="w-full h-auto object-cover rounded-md">

                            <!-- "X" to remove the photo -->
                            <button type="button" wire:click="removePhoto" class="absolute top-0 right-0 bg-red-500 text-white rounded-full p-1">
            ...
            <button
                ...
                class="mt-2 text-white bg-blue-500 rounded-xl px-2 py-1 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
